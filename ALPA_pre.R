...
# -> MinStpHrzLen:   30
# -> MinStpCnt:      6
# -> FilePrefix:     "lsd_c003_d000_r1.5_a015_l030_c006"
# 
# If you process an inventory consisting of many landslides,
# recommend not to output temporal results/files, and execute:
ALPA("lsd_dem.tif", "lsd_polygon.shp", 3, 0, 1.5, 15, 30, 6, "lsd_c003_d000_r1.5_a015_l030_c006")
# 
# If you process an individual landslide,
# you can try to output temporal results/files, and execute:
ALPA("lsd_dem.tif", "lsd_polygon.shp", 3, 0, 1.5, 15, 30, 6, "lsd_c003_d000_r1.5_a015_l030_c006", T)
#
#
#
...
# 7. The count of strip will be not smaller than MinStpCnt even a large MSHL is used.
#    A recommended value for MinStpCnt is 6, leaving at least 4 (6-2) strips,
#    for fitting strip data to cubic function in categorizing landslide longitudinal shape
#    Please be aware that the smallest count of strip is 2, no matter what MinStpCnt is.
