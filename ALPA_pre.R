...
# -> MinStpHrzLen:   30
# -> EndHdlAgrCfg:   1
# -> FilePrefix:     "lsd_c003_d000_r1.5_a015_l030_e001"
# 
# If you process an inventory consisting of many landslides,
# recommend not to output temporal results/files, and execute:
ALPA("lsd_dem.tif", "lsd_polygon.shp", 3, 0, 1.5, 15, 30, 1, "lsd_c003_d000_r1.5_a015_l030_e001")
# 
# If you process an individual landslide,
# you can try to output temporal results/files, and execute:
ALPA("lsd_dem.tif", "lsd_polygon.shp", 3, 0, 1.5, 15, 30, 1, "lsd_c003_d000_r1.5_a015_l030_e001", T)
#
#
#
...
#    try to re-calculate those landslides individually using an EndHdlAgrCfg value of 2.
...
# 8. Some problems of running ALPA 2.0 might be owing to the environment of user computer.
