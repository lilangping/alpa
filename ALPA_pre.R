...
#    -> DEMSliding:     if input DEM represents the sliding surface or not.
...
# -> FileDEM:        "lsd_dem.tif"
# -> FileLandslides: "lsd_polygon.shp"
# -> MinGrpPntCnt:   3
# -> MinGrpAcrDst:   0
# -> MinEndAptRto:   1.5
# -> MaxEndDvtAgl:   15
...
# -> EndHdlAgrCfg:   1
# -> DEMSliding:     0
# -> FilePrefix:     "lsd_c003_d000_r1.5_a015_l030_e001_s000"
# 
# If you process an inventory consisting of many landslides,
# recommend not to output temporal results/files, and execute:
ALPA("lsd_dem.tif", "lsd_polygon.shp", 3, 0, 1.5, 15, 30, 1, 0, "lsd_c003_d000_r1.5_a015_l030_e001_s000")
# 
# If you process an individual landslide,
# you can try to output temporal results/files, and execute:
ALPA("lsd_dem.tif", "lsd_polygon.shp", 3, 0, 1.5, 15, 30, 1, 0, "lsd_c003_d000_r1.5_a015_l030_e001_s000", T)
#
#
#
...
# 6. The spatial resolution of the used DEM is a reasonable value for MinStpHrzLen.
#    MinStpHrzLen controls generation of strips, and will not influence the generation of profile.
...
# 7. EndHdlAgrCfg can be 1 ~ 12. The recommendation for EndHdlAgrCfg is 1.
#    If the initial and distal anchors of some landslides are not satisfied,
#    try to re-calculate those landslides individually using an EndHdlAgrCfg value of 7 and 11.
#    If the strips of end groups for some landslides are not satisfied, 
#    try to re-calculate those landslides individually,
...
# 8. Set DEMSliding to be 0 (FALSE), if input DEM does not represent the sliding surface.
#    0 is the default choice, because usually DEM for the sliding surface is not available.
#    Set DEMSliding to be 1 or 2, if input DEM represents the sliding surface.
#    If choose 1, the original sliding surface elevation will be used as the elevation of profile.
#    If choose 2, the elevation of fitted plane will be used as the elevation of profile,
#    in such a way elevation fluctuations derived from sliding surface DEM will be smoothed.
