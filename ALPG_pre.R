...
#
#
# Please first execute the following command lines
# before applying the main function
#
# clear
rm(list = ls())
#
...
# 
# If you do not want to output temporal results (files)
...
#
# 2. The output profiles are two dimensional (2D) polylines
#    3D profiles (z-aware polylines) can be produced using software like ArcGIS
#
#
#
